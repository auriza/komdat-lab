...
batasan hanya bisa menginstal aplikasi web PHP/MySQL.
...
```bash
# fixme: tidak bisa upload gambar
chmod a+w ~/public_html/wordpress/wp-content
```
...
- kirim link video langkah instalasi dan link aplikasi web ke LMS
