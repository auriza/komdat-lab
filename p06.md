...
t2 OK Success
<b>t3 SELECT INBOX</b>
<i>* FLAGS (\Answered \Flagged \Draft \Deleted \Seen $NotPhishing $Phishing)
* 311 EXISTS
...</i>
t3 OK [READ-WRITE] INBOX selected. (Success)
<b>t4 FETCH 311 ALL</b>
<i>* 311 FETCH (ENVELOPE
                ("Tue, 21 Mar 2017 21:04:17 -0700 (PDT)"
                    "SMTP G64130108"
                    (("Mastur Fatullah" NIL "masturfatullah808" "gmail.com"))
                    (("Mastur Fatullah" NIL "masturfatullah808" "gmail.com"))
                    (("Mastur Fatullah" NIL "masturfatullah808" "gmail.com"))
                    (("Komdat Jarkom" NIL "komdatjarkom2" "gmail.com"))
                    NIL NIL NIL "<58d1f7c1.1716620a.c28ad.1242@mx.google.com>")
                FLAGS (\Seen)
                INTERNALDATE "22-Mar-2017 04:04:18 +0000"
                RFC822.SIZE 3092)</i>
t4 OK Success
