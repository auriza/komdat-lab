...
Server mengirimkan data ke *port* 20 (mode aktif) atau *ephemeral* (mode pasif).
Mode pasif lebih banyak dipakai oleh klien FTP (*lihat* <http://slacksite.com/other/ftp.html>).
...
...
220 smtp.google.com ESMTP xxx - gsmtp
<b>HELO localhost</b>
...
250 2.1.0 OK xxx - gsmtp
<b>RCPT TO: &lt;auriza.akbar@gmail.com&gt;</b>
250 2.1.5 OK xxx - gsmtp
<b>DATA</b>
354  Go ahead xxx - gsmtp
...
.</b>
250 2.0.0 OK 1489590573 xxx - gsmtp
<b>QUIT</b>
221 2.0.0 closing connection xxx - gsmtp</pre>
...
<pre>
$ <b>openssl s_client -connect pop.gmail.com:995 -crlf -ign_eof<!-- -CApath ~/.certs --></b>
---
