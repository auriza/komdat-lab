...
RETR tes.txt
150 Opening BINARY mode data connection for Release.gpg (6 bytes).
...
drwxr-xr-x   14 1004     1004         4096 Sep 28  2022 Documents
-rw-rw-r--    1 1004     1004           17 Feb 26  2020 fathiya.txt
...
```
